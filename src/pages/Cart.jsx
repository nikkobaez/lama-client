...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        const getCart = async () => {
            try {
                const res = await axios.get("https://lama-server-4377078eb805.herokuapp.com/cart/find/" + user._id, { headers })
    ...
    const handleCheckOut = async () => {
        try {
            const res = await axios.post("https://lama-server-4377078eb805.herokuapp.com/stripe/create-checkout-session", {
