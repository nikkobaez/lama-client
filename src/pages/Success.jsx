...
const Success = () => {
    ...
    useEffect(() => {
        if (stripeResponse) {
            const createOrder = async () => {
                try {
                    await axios.post("https://lama-server-4377078eb805.herokuapp.com/order", {
                    ...
                    await axios.put("https://lama-server-4377078eb805.herokuapp.com/cart/" + user._id + "/" + cart.id, [], { headers })
                } catch(error) {
    ...
    useEffect(() => {
        const getSession = async () => {
            try {
                const res = await axios.post("https://lama-server-4377078eb805.herokuapp.com/stripe/retrieve-checkout-session", {
