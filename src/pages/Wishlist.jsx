...
const Wishlist = () => {
    ...
    useEffect(() => {
        if (user && wishlist.id !== "") {
            ...
            const updateWishlist = async () => {
                try {
                    await axios.put("https://lama-server-4377078eb805.herokuapp.com/wishlist/" + user._id + "/" + wishlist.id, wishlist.products, { headers })
                } catch (error) {   
    ...
    useEffect(() => {
        ...
        const getWishlist = async () => {
            try {
                const res = await axios.get("https://lama-server-4377078eb805.herokuapp.com/wishlist/find/" + user._id, { headers })
